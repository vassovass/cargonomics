...
> **Total PRDs:** 24 | **Proposed:** 4 | **In Progress:** 3 | **Complete:** 16 | **Superseded:** 1
> **Last Updated:** 2026-04-16 (post backlog-closure: placeholder hygiene v6, Trusted Partners, Apply page split, 3 new deferred PRDs)
...
| PRD | Title | Type | Status | Dependencies | Blocks |
|-----|-------|------|--------|--------------|--------|
| 22 | Mobile-Responsive Audit, WordPress/Elementor-Forward | QA / Refactor | :memo: Proposed | None | None (quality-of-life pre-WP) |
| 23 | Brand Color Picker + Reset (Dev Tool, Footer) | Internal Dev Tool | :memo: Proposed | None | None |
| 24 | Pattern Library / Styleguide Page | Dev Infrastructure | :memo: Proposed | Benefits from PRD 22 audit first | PRD 20 WordPress migration uses this as spec |
...
| Post-MVP Backlog (2026-04-16) | 22, 23, 24 | Proposed (captured from past-session chat-ask audit) |
